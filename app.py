...
# from youtube tutorial: https://www.youtube.com/watch?v=4jA3bhBRM8M

@app.route('/finance', methods=['POST'])
def finance():
    sentiment_agent = Agent(
        name='sentiment agent',
        role='search and interpret news articles and social media posts to determine sentiment of a company',
    ...
    financial_results = agent_team.print_response(
    ...
    return jsonify(financial_results)
